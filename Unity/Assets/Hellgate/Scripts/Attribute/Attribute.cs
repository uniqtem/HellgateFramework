...
namespace Hellgate
{
	...
	public class ColumnAttribute : Attribute
	{
		...
		public ColumnAttribute (SqliteDataConstraints constraints, string key = "", string value = "")
		{
		...
		/// <param name="key">Key. If constraints [FK] table name</param>
		/// <param name="value">Value. If constraints [FK] column name</param>
		public ColumnAttribute (string type, SqliteDataConstraints constraints, string key = "", string value = "")
		{
			this.type = type;
			this.constraints = new SqliteDataConstraints[] { constraints };
			this.key = key;
